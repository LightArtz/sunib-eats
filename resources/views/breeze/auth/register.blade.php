<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <!-- Profile Picture -->
        <div class="mt-4">
            <x-breeze::input-label for="profile_picture" :value="__('Profile Picture')" />
            <x-breeze::text-input id="profile_picture" class="block mt-1 w-full" type="file" name="profile_picture" />
            <x-breeze::input-error :messages="$errors->get('profile_picture')" class="mt-2" />
        </div>
        ...
        <!-- Phone Number -->
        <div class="mt-4">
            <x-breeze::input-label for="phone_number" :value="__('Phone Number')" />
            <x-breeze::text-input id="phone_number" class="block mt-1 w-full" type="text" name="phone_number" required />
            <x-breeze::input-error :messages="$errors->get('phone_number')" class="mt-2" />
        </div>

        <!-- Date of Birth -->
        <div class="mt-4">
            <x-breeze::input-label for="date_of_birth" :value="__('Date of Birth')" />
            <x-breeze::text-input id="date_of_birth" class="block mt-1 w-full" type="date" name="date_of_birth" required />
            <x-breeze::input-error :messages="$errors->get('date_of_birth')" class="mt-2" />
        </div>
